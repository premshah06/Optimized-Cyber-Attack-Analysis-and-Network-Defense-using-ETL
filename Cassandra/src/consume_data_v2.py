...
# Constants
NUM_PARTITIONS = 6  # Match Kafka topic partitions
...
def create_cassandra_session():
    ...
    # Ensure table exists
    session.execute("""
        CREATE TABLE IF NOT EXISTS network_traffic_v2 (
            id UUID,
            source_ip TEXT,
            destination_ip TEXT,
            source_port INT,
            ...
            packet_size INT,
            attack_label TEXT ,
            PRIMARY KEY (attack_label, time_stamp)
...
def insert_to_cassandra(session, data_batch):
    ...
    prepared_insert = session.prepare("""
        INSERT INTO network_traffic_v2 (
