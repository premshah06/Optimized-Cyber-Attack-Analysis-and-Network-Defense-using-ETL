...
# Load CICIDS dataset
cicids_data = pd.read_csv('/Users/mayankkapadia/Desktop/synthetic_network_traffic_v2.csv')
...
for _, row in cicids_data.iterrows():
    data = row.to_dict()
    producer.send('cicids_traffic_2', value=data)  # Ensure proper partitioning
